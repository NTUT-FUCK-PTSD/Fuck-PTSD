...
void App::InitStart() {
  ...
  m_Protagonist =
    std::make_shared<Character>(ASSETS_DIR "/entities/player1_armor_body.png");

  m_Protagonist->SetAnimation(glm::vec2(24.0f, 24.0f),
  ...
  m_Protagonist =
    std::make_shared<Character>(ASSETS_DIR "/entities/player1_heads.png");

  m_Protagonist->SetAnimation(glm::vec2(24.0f, 13.0f),
                              std::vector<std::size_t>{0, 1, 2, 3},
                              true,
                              100,
                              true,
...
void App::InitUpdate() {
  ...
  if (ToolBoxs::IsAnyKeyPress()) {
    Begin::RemoveBackground(
      this->m_Root, this->m_SaveBackground[0], this->m_SaveBackground[1]);
