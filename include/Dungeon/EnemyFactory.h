...
public:
    static std::shared_ptr<Enemy> CreateEnemy(
        ...
        switch (u_Enemy.type) {
            case 0:
                return std::make_shared<Enemies::GreenSlime>(
                    u_Enemy,
                    simpleMapData
                );
            case 1:
                return std::make_shared<Enemies::BlueSlime>(
                    u_Enemy,
                    simpleMapData
                );
            case 2:
                return std::make_shared<Enemies::OrangeSlime>(
                    u_Enemy,
                    simpleMapData
                );
            case 3:
                return std::make_shared<Enemies::Skeleton>(
                    u_Enemy,
                    simpleMapData
                );
            case 4:
            ...
            case 12:
                return std::make_shared<Enemies::Zombie>(
                    u_Enemy,
                    simpleMapData
                );
